...
class Helpers
{
    ...
    public static function send_order_notification($order)
    {
        ...
        try {
            ...
            if(($order->payment_method == 'cash_on_delivery' && $order->order_status == 'confirmed' )||($order->payment_method != 'cash_on_delivery' && $order->order_status == 'confirmed' )){
                $data = [
            ...
            if ($order->order_type == 'delivery' && !$order->scheduled && $status == 'confirmed' && $order->payment_method == 'cash_on_delivery' && config('order_confirmation_model') == 'deliveryman') {
            ...
            if (!$order->scheduled && (($order->order_type == 'take_away' && $order->order_status == 'confirmed') || ($order->payment_method != 'cash_on_delivery' && $order->order_status == 'confirmed'))) {
                $data = [
                    'title' => translate('messages.order_push_title'),
                    'description' => translate('messages.new_order_push_description'),
                    'order_id' => $order->id,
