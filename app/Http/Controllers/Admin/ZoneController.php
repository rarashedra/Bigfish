...
class ZoneController extends Controller
{
    ...
    {
        // $request->validate([
        //     'cash_on_delivery' => 'required_without:bigfish',
        //     'bigfish' => 'required_without:cash_on_delivery',
        ...
        $zone->cash_on_delivery = $request->cash_on_delivery?1:0;
        $zone->otp = $request->otp?1:0;
        $zone->kh = $request->kh?1:0;
        $zone->mbh = $request->mbh?1:0;
        $zone->paypal = $request->paypal?1:0;
        $zone->stripe = $request->stripe?1:0;
      //  $zone->digital_payment = $request->digital_payment?1:0;
