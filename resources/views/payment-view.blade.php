        ...
        <section class="col-lg-12">
            <div class="checkout_details mt-3">
                <div class="row">
                        ...
                        <div class="col-md-6 mb-4 cursor-pointer">
                            <div class="card">
                                <div class="card-body h--100px">
                                    <!--<button type="button" class="btn btn-block click-if-alone" data-toggle="modal" data-target="#bigfish">-->
                                    <!--    <img width="150"-->
                                    <!--    src="{{asset('public/assets/admin/img/bigfish.png')}}"/>-->
                                    <!--</button>-->
                                    <a class="btn btn-block click-if-alone" href="{{route('bigfish-payment',request()->getQueryString())}}">
                                        <img class="initial--41"
                                            src="{{asset('public/assets/admin/img/bigfish.png')}}"/>
                                    </a>
                                </div>
                                  <!-- Modal -->
                    <!--<div class="modal fade" id="bigfish" tabindex="-1" role="dialog" aria-labelledby="bigfishLabel" aria-hidden="true">-->
                    <!--    <div class="modal-dialog modal-dialog-centered" role="document">-->
                    <!--        <div class="modal-content">-->
                    <!--            <div class="modal-header">-->
                    <!--                <h4 class="modal-title" class="text-center" id="bigfishLongTitle">{{translate('select OTP K&H and MBH payment system')}}</h4>-->
                    ...
                    <!--                <div class="card-body">-->
                    <!--                    <form action="{{ route('bigfish-payment') }}" method="GET" >-->
                    <!--                        <input type="hidden" name="mode" value="OTP">-->
                    <!--                        <input type="hidden" name="order_id" value="{{ $order->id }}">-->
                    <!--                        <button class="btn btn-block btn-primary btn-lg click-if-alone" type="submit">-->
                    <!--                           <strong>{{ translate('messages.OTP SZÉP Card') }}</strong>-->
                    <!--                        </button>-->
                    <!--                    </form>-->
                    <!--                </div>-->
                    <!--                <div class="card-body">-->
                    <!--                    <form action="{{ route('bigfish-payment') }}" method="GET" >-->
                    <!--                        <input type="hidden" name="mode" value="KHBSZEP">-->
                    <!--                        <input type="hidden" name="order_id" value="{{ $order->id }}">-->
                    <!--                        <button class="btn btn-block btn-success btn-lg click-if-alone" type="submit">-->
                    <!--                           <strong> {{ translate('messages.K&H SZÉP Card') }}</strong>-->
                    <!--                        </button>-->
                    <!--                    </form>-->
                    <!--                </div>-->
                    <!--                <div class="card-body">-->
                    <!--                    <form action="{{ route('bigfish-payment') }}" method="GET" >-->
                    <!--                        <input type="hidden" name="mode" value="MKBSZEP">-->
                    <!--                        <input type="hidden" name="order_id" value="{{ $order->id }}">-->
                    <!--                        <button class="btn btn-block btn-success btn-lg click-if-alone" type="submit">-->
                    <!--                           <strong> {{ translate('messages.MBH SZÉP Card') }}</strong>-->
                    <!--                        </button>-->
                    <!--                    </form>-->
                    <!--                </div>-->
                    <!--            </div>-->
