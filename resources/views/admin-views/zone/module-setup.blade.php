                ...
                <div class="col-12">
                    ...
                    <div class="check--item-wrapper mb-1">
                      ...
                      {{--  <div class="check-item">
                        ...
                        <div class="check-item">
                            <div class="form-group form-check form--check">
                                <input type="checkbox" name="paypal" value="paypal" class="form-check-input"
                                       id="paypal" {{$zone->paypal == 1 ?'checked':''}}>
                                <label class="form-check-label qcont text-dark" for="paypal">{{translate('messages.paypal')}}</label>
                            </div>
                        </div>
                        <div class="check-item">
                            <div class="form-group form-check form--check">
                                <input type="checkbox" name="stripe" value="stripe" class="form-check-input"
                                       id="stripe" {{$zone->stripe == 1 ?'checked':''}}>
                                <label class="form-check-label qcont text-dark" for="stripe">{{translate('messages.stripe')}}</label>
                            </div>
                        </div>
                        <div class="check-item">
                            <div class="form-group form-check form--check">
                                <input type="checkbox" name="otp" value="otp" class="form-check-input"
                                       id="otp" {{$zone->otp == 1 ?'checked':''}}>
                                <label class="form-check-label qcont text-dark" for="otp">{{translate('messages.otp')}}</label>
                            </div>
                        </div>
                        <div class="check-item">
                            <div class="form-group form-check form--check">
                                <input type="checkbox" name="kh" value="kh" class="form-check-input"
                                       id="kh" {{$zone->kh == 1 ?'checked':''}}>
                                <label class="form-check-label qcont text-dark" for="kh">{{translate('messages.kh')}}</label>
                            </div>
                        </div>
                        <div class="check-item">
                            <div class="form-group form-check form--check">
                                <input type="checkbox" name="mbh" value="mbh" class="form-check-input"
                                       id="mbh" {{$zone->mbh == 1 ?'checked':''}}>
                                <label class="form-check-label qcont text-dark" for="mbh">{{translate('messages.mbh')}}</label>
                            </div>
                        </div>
                    </div>
