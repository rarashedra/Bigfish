              ...
              <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <form
                            action="{{ env('APP_MODE') != 'demo' ? route('admin.business-settings.payment-method-update', ['bigfish']) : 'javascript:' }}"
                            method="post">
                            @csrf
                            @if (isset($config))
                                <h5 class="d-flex flex-wrap justify-content-between">
                                    <strong>{{ translate('messages.bigfish') }}</strong>
                                    <label class="switch--custom-label toggle-switch toggle-switch-sm d-inline-flex">
                                        <span
                                ...
                                <div class="payment--gateway-img">
                                    <img src="{{ asset('/public/assets/admin/img/bigfish.png') }}" alt="public">
                                </div>
                                <div class="form-group mb-4">
                                    <select name="mode" id="" class="form-control">
                                        <option value="live" {{ $config['mode'] == 'live' ? 'selected' : '' }}>Live
                                        </option>
                                        <option value="test" {{ $config['mode'] == 'test' ? 'selected' : '' }}>Test
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group mb-4">
                                ...
                                <div class="btn--container justify-content-end">
                                    <button type="button"
                                        class="btn h--37px btn-success"onclick="copy_text('{{ $url }}')">{{ translate('messages.copy_domain') }}</button>
                                    <button type="{{ env('APP_MODE') != 'demo' ? 'submit' : 'button' }}"
